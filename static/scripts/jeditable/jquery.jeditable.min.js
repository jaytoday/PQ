...
(function($){$.fn.editable=function(target,options){var settings={target:target,name:'value',id:'id',type:'text',width:'auto',height:'auto',event:'click',onblur:'cancel',loadtype:'GET',loadtext:'Loading...',placeholder:'',loaddata:{},submitdata:{}};if(options){$.extend(settings,options);}
...
if($(this).html().toLowerCase().replace(/;/,'')==settings.placeholder.toLowerCase().replace(/;/,'')){$(this).html('');} var markup = $(this).html();  $(this).html(markup.replace(/style="opacity: 1;"/g, '')); 
