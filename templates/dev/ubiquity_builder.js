        ...
        var runCode = function() {
          ...
          //container is draggable
          	...
          	var cancel_drag = select('cancel_drag');
          		cancel_drag.mousedown(function(event){ element.data('cancel', true) });
          		cancel_drag.mouseup(function(event){ element.data('cancel', false) });
